    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GeekBrainsShop.DAL.Employees.LibraryContext>
    {
        ...
        protected override void Seed(GeekBrainsShop.DAL.Employees.LibraryContext context)
        {
            context.Footwear.AddOrUpdate(x => x.FootwearId,
                ...
                new Footwear() { FootwearId = 4, Price = 1500, MinSize = 40, MaxSize = 46, VendorCode = "KL63-18L", ImageLink = @"/Content/Images/sport_1_small.jpg", TrademarkId = 2, SalePrice = 1500, IsSale = true, IsTop = true, IsNew = true, Subscribe = "asddf", SeasonId = 2 },
                ...
                new Footwear() { FootwearId = 8, Price = 2500, MinSize = 39, MaxSize = 45, VendorCode = "ZK00-22F", ImageLink = @"/Content/Images/sport_1_small.jpg", TrademarkId = 2, SalePrice = 2000, IsSale = false, IsTop = false, IsNew = false, Subscribe = "asddf", SeasonId = 1 });
            ...
            context.Season.AddOrUpdate(x => x.SeasonId,
                new Season() { SeasonId = 1, SeasonName = "Season1" },
                new Season() { SeasonId = 2, SeasonName = "Season2" });
